...
param <- list(objective = "binary:logistic",eta=.1,max_depth =6,min_child_weight =10,colsample_bytree =.5,subsample = .7)
xgb.model <- xgb.train(param =param,  data = xgb.train.data, nrounds=3000,print_every_n = 50,early_stopping_rounds = 50,watchlist = watchlist)
